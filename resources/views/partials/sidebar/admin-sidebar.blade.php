<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
       <ul class="space-y-2 font-medium">
          ...
          <li {{ Request::is('admin/partners*') ? 'bg-menubar dark:bg-purple-700 rounded-lg' : '' }}>
             <a href="{{ route('admin.partners.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                    <path d="M184 48H328c4.4 0 8 3.6 8 8V96H176V56c0-4.4 3.6-8 8-8zm-56 8V96H64C28.7 96 0 124.7 0 160v96H192 320 512V160c0-35.3-28.7-64-64-64H384V56c0-30.9-25.1-56-56-56H184c-30.9 0-56 25.1-56 56zM512 288H320v32c0 17.7-14.3 32-32 32H224c-17.7 0-32-14.3-32-32V288H0V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V288z"/>
                </svg>
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Loker</span>
            ...
            {{-- <ul id="dropdown-example" class="{{ Request::is('operationals/tiketing-psb*') ||  Request::is('operationals/work-orders*') ? '' : 'hidden' }} py-2 space-y-2"> --}}
                  <li class="{{ Request::is('admin/loker-partners*') ? 'text-white bg-blue-600 dark:bg-purple-700 rounded-lg' : 'text-black' }}">
                    <a href="{{ route('admin.loker-partners.index')  }}" class="flex items-center w-full p-2 text-gray-900 rounded-lg transition duration-75 pl-11 group dark:text-white hover:bg-blue-800 dark:hover:bg-purple-800">
                        <span class="flex-1 text-black whitespace-nowrap">Data Loker</span>
                     </a>
                  </li>
          ...
          <li {{ Request::is('admin/candidates*') ? 'bg-menubar dark:bg-purple-700 rounded-lg' : '' }}>
             <a href="{{ route('admin.candidates.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Data Pelamar</span>
             </a>
          </li>
       </ul>
    </div>
