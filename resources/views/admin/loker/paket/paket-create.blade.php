    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400">Paket</span>
            </div>
        </li>
        <li aria-current="page">
            <div class="flex items-center">
...
<div class="bg-white p-4 rounded-lg">
    <form id="createForm" action="{{ route('admin.packages.store') }}" method="post">
        @csrf
