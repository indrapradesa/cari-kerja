...
@section('container')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Loker</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="flex">
        ...
        <a href="{{ route('admin.loker-partners.create') }}"
            class="ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            type="button">
            Tambah Loker
        </a>
    </div>
            ...
            <tbody>
                @foreach ($results as $data)
                    <tr
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{ $data->date_closing == null ? '-' : $data->date_closing }}
                        </td> --}}
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="flex gap gap-2">
                                <a href="{{ route('admin.loker-partners.show', $data->id) }}" class="text-blue-600 bg-transparent font-medium">
                                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" fill="currentColor">
                                        <path d="M48 80a48 48 0 1 1 96 0A48 48 0 1 1 48 80zM0 224c0-17.7 14.3-32 32-32H96c17.7 0 32 14.3 32 32V448h32c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H64V256H32c-17.7 0-32-14.3-32-32z"/>
                                    </svg>
                                </a>
                                {{-- <button data-modal-target="updateProductModal" data-modal-toggle="updateProductModal"
                                    data-id="{{ $data->id }}" class="text-blue-600 bg-transparent font-medium">
