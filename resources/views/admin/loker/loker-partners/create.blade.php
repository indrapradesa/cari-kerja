...
@section('container')
    ...
    <div class="bg-white p-4 rounded-lg">
        <form id="createForm" action="{{ route('admin.loker-partners.store') }}" method="post">
            @csrf
            <div class="mb-2">
                <label for="partner_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Partner</label>
            ...
            <div class="mb-2 grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select id="type_job" name="type_job"
                        ...
                        <option selected>--Jenis Loker--</option>
                    ...
                    <select id="category_id" name="category_id"
                        ...
                        @foreach ($kategoriLoker as $kategori)
                            @if (old('category_id') == $kategori->id)
                                <option value="{{ $kategori->id }}" selected>{{ $kategori->name_category }}</option>
                            @else
                ...
                <div>
                  ...
                  @enderror"
                    ...
                    <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Isi Jika Ada
                        Range Gaji.</p>
                    @error('salary_max')
                        <div class="invalid-feedback text-gray-900 dark:text-white">
                            {{ $message }}
