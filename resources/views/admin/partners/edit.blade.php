...
<nav class="flex px-2 mb-4" aria-label="Breadcrumb">
...
<div class="w-full bg-white p-4 rounded-md">
    <h6 class="text-lg font-bold dark:text-white">Edit Partner</h6>
            <div class="border-b border-solid mb-2 mt-2"></div>
    <form>
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name Partner</label>
